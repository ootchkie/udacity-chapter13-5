...
while (num>1) {// check value of num
    ...
    :(num!==99)||(num===2))?(
                 ...
                 +num+" bottles of juice on the wall! "//you need extra bottle to play the game, another bottle please!)    
                 +num+" bottles of juice"
                 +" Take one down, pass it around... "//you better f@#!n pass it!
                 +(num-1)+" bottle of juice on the wall!"
                 
                 )
    //else                                                                        //this is such a long line, sigh!
